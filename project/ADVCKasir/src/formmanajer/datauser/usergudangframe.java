...
public class usergudangframe extends javax.swing.JFrame {

    DefaultTableModel tabModel;
    ResultSet RsBarang=null;

    public usergudangframe() {
        initComponents();
        waktu();
        tampilData();
        SetEditOff();
        bgudang.setEnabled(false);
    }
    ...
    private void tampilData(){
        try{
            ...
            RsBarang=stt.executeQuery("SELECT * from user_gudang ORDER BY nama ASC");
            while(RsBarang.next()){
                Object[] data={
   ...
   private void seteditOn(){
    ...
    private void initComponents() {
        ...
        jLabel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data User Gudang", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Calibri", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        jPanel2.add(jLabel3);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        setExtendedState(usergudangframe.MAXIMIZED_BOTH);
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        if (nama.isEmpty() ) {
            ...
            try{
                Connection conn=(Connection)koneksi.GetConnection();
                Statement stt=conn.createStatement();
                stt.executeUpdate("DELETE FROM user_gudang WHERE nama='"+nama+"'");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void bperbaruiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bperbaruiActionPerformed
        ...
        if (nama.isEmpty() ) {
            ...
            try{
                ...
                stt.executeUpdate("UPDATE user_gudang SET username='"+user+"', password='"+pass+"', hp='"+hp+"', email='"+email+"', alamat='"+alamat+"' WHERE nama='"+nama+"'");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        if (nama.isEmpty() ) {
            ...
            try{
                Connection conn=(Connection)koneksi.GetConnection();
                Statement stt=conn.createStatement();
                stt.executeUpdate("insert into user_gudang(nama,username,password,hp,email,alamat)"+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usergudangframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new usergudangframe().setVisible(true);
            }
        });
    }
