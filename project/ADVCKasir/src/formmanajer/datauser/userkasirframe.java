...
public class userkasirframe extends javax.swing.JFrame {

    DefaultTableModel tabModel;
    ResultSet RsBarang=null;

    public userkasirframe() {
        initComponents();
        waktu();
        tampilData();
        SetEditOff();
        bkasir.setEnabled(false);
    }
    ...
    private void tampilData(){
        try{
            ...
            RsBarang=stt.executeQuery("SELECT * from user_kasir ORDER BY nama ASC");
            while(RsBarang.next()){
                Object[] data={
   ...
   private void seteditOn(){
    ...
    private void initComponents() {
        ...
        jLabel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data User Kasir", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Calibri", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        jPanel2.add(jLabel3);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        setExtendedState(userkasirframe.MAXIMIZED_BOTH);
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        if (nama.isEmpty() ) {
            ...
            try{
                Connection conn=(Connection)koneksi.GetConnection();
                Statement stt=conn.createStatement();
                stt.executeUpdate("DELETE FROM user_kasir WHERE nama='"+nama+"'");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void bperbaruiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bperbaruiActionPerformed
        ...
        if (nama.isEmpty() ) {
            ...
            try{
                ...
                stt.executeUpdate("UPDATE user_kasir SET username='"+user+"', password='"+pass+"', hp='"+hp+"', email='"+email+"', alamat='"+alamat+"' WHERE nama='"+nama+"'");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        if (nama.isEmpty() ) {
            ...
            try{
                Connection conn=(Connection)koneksi.GetConnection();
                Statement stt=conn.createStatement();
                stt.executeUpdate("insert into user_kasir(nama,username,password,hp,email,alamat)"+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(userkasirframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new userkasirframe().setVisible(true);
            }
        });
    }
