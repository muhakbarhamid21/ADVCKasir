...
public class penjualanframe extends javax.swing.JFrame {
    ...
    private void tampilData(){
        try{
            Object[] judul_kolom = {"Tanggal", "Faktur", "Nama Barang", "Kode Barang", "Total", "HPP", "Laba"};
            ...
            RsBarang=stt.executeQuery("SELECT DATE_FORMAT(tanggal, '%d %M %Y'), no_faktur, nama_barang, kode_barang, subtotal_barang, hpp, laba FROM faktur");
            while(RsBarang.next()){
                Object[] data={
                    RsBarang.getString("DATE_FORMAT(tanggal, '%d %M %Y')"),
                    RsBarang.getString("no_faktur"),
                    RsBarang.getString("nama_barang"),
                    RsBarang.getString("kode_barang"),
                    RsBarang.getString("subtotal_barang"),
                    RsBarang.getString("hpp"),
                    RsBarang.getString("laba"),
                };
    ...
    public void total(){
        ...
        try {
            ...
            RsBarang=stt.executeQuery("SELECT SUM(`subtotal_barang`) AS total FROM faktur");
    ...
    public void hpp(){
        ...
        try {
            ...
            RsBarang=stt.executeQuery("SELECT SUM(`hpp`) AS hpp FROM faktur");
    ...
    public void laba(){
        ...
        try {
            ...
            RsBarang=stt.executeQuery("SELECT SUM(`laba`) AS laba FROM faktur");
    ...
    private void initComponents() {
        ...
        jLabel31.setText("HPP");
        plaba.add(jLabel31);
        jLabel31.setBounds(4, 2, 90, 30);
        ...
        jLabel32.setText("Laba");
        phpp.add(jLabel32);
        jLabel32.setBounds(4, 2, 90, 30);
        ...
        jLabel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Laporan Penjualan", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Calibri", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        jPanel2.add(jLabel3);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        setExtendedState(penjualanframe.MAXIMIZED_BOTH);
