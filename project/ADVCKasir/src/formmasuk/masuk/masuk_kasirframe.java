 ...
 * @author asus
 */
public class masuk_kasirframe extends javax.swing.JFrame {

    /**
     * Creates new form masuk_kasirframe
     */
    public masuk_kasirframe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/formmasuk/masuk/images/masuk-kasir.png"))); // NOI18N
        jLabel1.setText("jLabel1");
        jLabel1.setPreferredSize(new java.awt.Dimension(748, 736));
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        this.setState(masuk_kasirframe.ICONIFIED);
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        try {
            ...
            ResultSet result=statement.executeQuery("select * from user_kasir where " + "username='" + txuser.getText() + "'");
            if (result.next()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "GAGAL TERKONEKSI DENGAN DATABASE GUS !!!");
        }    
        ...
        try {
            ...
            if (Desktop.isDesktopSupported()) {
                try {
                    ...
                    Logger.getLogger(masuk_kasirframe.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(masuk_kasirframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new masuk_kasirframe().setVisible(true);
            }
        });
    }
