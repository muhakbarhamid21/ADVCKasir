 ...
 * @author asus
 */
public class masuk_gudangframe extends javax.swing.JFrame {
    
    /**
     * Creates new form masuk_gudangframe
     */
    public masuk_gudangframe() {
        initComponents();
    }   
    ...
    private void initComponents() {
        ...
        txuser.setFont(new java.awt.Font("Calibri", 0, 36)); // NOI18N
        ...
        txpass.setFont(new java.awt.Font("Calibri", 0, 36)); // NOI18N
        txpass.setBorder(null);
        getContentPane().add(txpass);
        txpass.setBounds(110, 388, 600, 86);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/formmasuk/masuk/images/masuk-gudang.png"))); // NOI18N
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        try {
            ...
            ResultSet result=statement.executeQuery("select * from user_gudang where " + "username='" + txuser.getText() + "'");
            if (result.next()) {
                if (txpass.getText().equals(result.getString("password"))) {
                            menuframe mf = new menuframe();
                            mf.setVisible(true);
                            gudangframe gf = new gudangframe();
                            gf.setVisible(true);
                            this.dispose();
            ...
            JOptionPane.showMessageDialog(rootPane, "GAGAL TERKONEKSI DENGAN DATABASE BROW !!!");
        }             
        ...
        try {
            ...
            if (Desktop.isDesktopSupported()) {
                try {
                    ...
                    Logger.getLogger(masuk_gudangframe.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(masuk_gudangframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new masuk_gudangframe().setVisible(true);
        });
    }
